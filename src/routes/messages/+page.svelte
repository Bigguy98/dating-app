...
<section class="h-full">
    <div class="p-4 sm:ml-64 h-full">
       <!-- This is an example component -->
        <div class=" mx-auto shadow-lg rounded-lg h-full">
        <!-- Chatting -->
            <div class="flex flex-row justify-between bg-white">
                ...
                <!-- chat list -->
                <div class="flex flex-col w-2/5 border-r-2 overflow-y-auto  text-gray-900 rounded-lg dark:text-white bg-gray-100 dark:hover:bg-gray-700" >
                    <!-- search compt -->
